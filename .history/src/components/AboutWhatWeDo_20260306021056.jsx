...
<div className="col-md-6">
  ...
  <FlipCard
    ...
    frontText="We promote well-being via advocacy, support services, welfare initiatives, and strong community among medical students."
    backTitle="Mind Over Matter"
    backText="Mind Over Matter is a mental health and wellness club dedicated to supporting medical students through open conversations, peer support, and wellness initiatives."
  />
