...
const AboutWhatWeDo = () => {
  ...
  frontText="We conduct medical camps, health education drives, screenings, and awareness campaigns in underserved communities and underrepresented health conditions."
  backTitle="What We Do"
  backText="Students collaborate with healthcare professionals to organize outreach programs that deliver preventive care, health screenings, and education to communities with limited access to healthcare."
/>
